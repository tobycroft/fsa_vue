...
export default {
  ...
  created() {
    this.associationInfoListAPI();
  },

  methods: {
    handleSelect(id, name) {
      sessionStorage.setItem("selectAssociation", JSON.stringify({ id, name }));
     ...
     *   机构列表
     */
    async associationInfoListAPI() {
      const res = await this.$request("association.associationInfoList");
