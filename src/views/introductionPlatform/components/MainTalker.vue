<template>
  <div class="main-talker-container">
    <Card :radius="16" class="card-style flex-start">
      ...
      <div class="info-box">
        ...
        <div class="flex">
          <div class="tag-style">
            <p class="tag-value">{{ patrolDistricts }}</p>
            <p class="tag-label">巡讲区县</p>
          </div>
          <div class="tag-style">
            <p class="tag-value">{{ activitySession }}</p>
            <p class="tag-label">活动场次</p>
          </div>
          <div class="tag-style">
            <p class="tag-value">{{ participation }}</p>
            <p class="tag-label">参与人数</p>
          </div>
        </div>
      </div>
    </Card>
